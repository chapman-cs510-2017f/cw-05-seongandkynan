...
def test_cplane():
    ...
    assert LCP.plane == [(-4-4j), (-4-3j), (-4-2j), (-4-1j), (-4+0j), (-4+1j), (-4+2j), (-4+3j), (-4+4j), (-3-4j), (-3-3j), (-3-2j), (-3-1j), (-3+0j), (-3+1j), (-3+2j), (-3+3j), (-3+4j), (-2-4j), (-2-3j), (-2-2j), (-2-1j), (-2+0j), (-2+1j), (-2+2j), (-2+3j), (-2+4j), (-1-4j), (-1-3j), (-1-2j), (-1-1j), (-1+0j), (-1+1j), (-1+2j), (-1+3j), (-1+4j), -4j, -3j, -2j, -1j, 0j, 1j, 2j, 3j, 4j, (1-4j), (1-3j), (1-2j), (1-1j), (1+0j), (1+1j), (1+2j), (1+3j), (1+4j), (2-4j), (2-3j), (2-2j), (2-1j), (2+0j), (2+1j), (2+2j), (2+3j), (2+4j), (3-4j), (3-3j), (3-2j), (3-1j), (3+0j), (3+1j), (3+2j), (3+3j), (3+4j), (4-4j), (4-3j), (4-2j), (4-1j), (4+0j), (4+1j), (4+2j), (4+3j), (4+4j)]
...
def test_cplane4():
    ...
    assert LCP.plane == [32j, (12+16j), (16-0j), (12-16j), -32j, (-12+16j), 8j, (4-0j), -8j, (-12-16j), (-16-0j), (-4-0j), 0j, (-4+0j), (-16+0j), (-12-16j), -8j, (4+0j), 8j, (-12+16j), -32j, (12-16j), (16+0j), (12+16j), 32j]
